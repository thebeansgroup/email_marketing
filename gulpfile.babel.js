...
Inky.prototype.componentLibrary.lockedofferbutton = function (element) {
  var expander = '';
...
Inky.prototype.componentLibrary.alertblock = function (element) {
  var classes = [];
  if (element.attr('class')) {
    classes = classes.concat(element.attr('class').split(' '));
  }
  ...
  return format('<container class="%s"><row class="collapse collapse-bottom"><columns class="hide-for-large" small="6" large="6"><img src="%s"></columns></row><row class="collapse collapse-bottom"><columns small="12" large="6"><center><spacer size="35"></spacer><h6 class="alert__title text-center">%s</h6><spacer size="15"></spacer><p class="alert__text text-center">%s</p><spacer size="25"></spacer><lockedofferbutton href="%s">%s</lockedofferbutton><spacer size="25"></spacer></center></columns><columns class="show-for-large" small="12" large="6"><img src="%s"></columns></row></container>', classes.join(' '), mobileImage, title, text, buttonHref, buttonText, image);
};
...
function pages() {
  return gulp.src('src/pages/**/*.html')
    ...
    .pipe(inky({
      components: {
        lockedofferbutton: 'lockedofferbutton',
        header: 'header',
        footer: 'footer',
